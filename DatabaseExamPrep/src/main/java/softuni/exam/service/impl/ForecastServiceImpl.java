...
public class ForecastServiceImpl implements ForecastService {
    ...
    public String importForecasts() throws IOException, JAXBException {
        ...
        final ForecastsImportWrapperDto forecastsImportWrapperDto =
                xmlParser.fromFile(file, ForecastsImportWrapperDto.class);

        final List<ForecastImportDto> forecasts = forecastsImportWrapperDto.getForecasts();
